---
allowed-tools: Agent
description: Smart commit with auto-split detection (runs via Haiku agent)
---

Use the Agent tool with `model: "haiku"` to analyze git changes and propose commits.
...
Relay the agent's response to the user as-is.
